...
class DatasetManager(Dataset):
    ...
    def __getitem__(self, idx):
        try:
            ...
            # Simple augmentation (only horizontal flip to maintain mask correspondence)
...
def load_coco_data(dir_root, dir_name, file_name='_annotations.coco.json'):
...
def create_dataset(coco_data, dir_root, dir_name, category_id_to_index, target_size):
